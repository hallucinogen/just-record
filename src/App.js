...
const App = () => {
    ...
    return (_jsx("div", { className: "App", children: _jsx("div", { className: "layout", children: _jsxs("div", { style: {
                    display: "relative",
                    alignItems: "center",
                    width: "100%"
                }, children: [_jsx("video", { id: "video", style: { height: permissionAllowed ? "100vh" : "80vh", backgroundColor: "#444" }, autoPlay: true, muted: true, playsInline: true, children: "Your browser does not support the video tag." }), !permissionAllowed ? _jsx(NoPermission, {}) : _jsx(Control, { started: started, onStart: startRecording, onStop: stopRecording })] }) }) }));
};
export default App;
